...
> **Current release: v0.9.6.** Works standalone. Identity is a single key you also use across Qurator and the wider Nostr network. Hoardbook handles *introductions and catalogs only* — the actual file downloads happen in a separate companion app, [Mascara](#the-qurator-family).
