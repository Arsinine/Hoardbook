...
By default Hoardbook spreads across public Nostr relays (`nos.lol`, `relay.primal.net`, `relay.snort.social`, `offchain.pub`). You can add or swap relays in **Settings → Relays** (only `wss://` is accepted).
