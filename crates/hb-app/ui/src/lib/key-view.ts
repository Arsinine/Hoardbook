...
const NO_RECOVERY =
	'Your npub is your identity. There is no reset if you lose it. ' +
	...
	return {
		rows: [
			...
			// npub). It carries the browse-key, so it is PRIVATE — hand it only to people you trust.
			{
				...
				value: id.share_code,
				sensitive: true,
				hint: 'Private. Give it only to people you want browsing your collections. It also lets them find, add, and DM you. Keep it off public threads.',
			},
