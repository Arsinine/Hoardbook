...
mod tests {
    ...
    fn dm_delivery_targets_keeps_own_and_public_peer_relays() {
        ...
        let targets = vec![
            ...
            "ws://141.98.199.138:7777".to_string(), // peer, public plain-ws VPS relay — kept (address class, not scheme)
        ];
        ...
        assert!(kept.contains(&"ws://141.98.199.138:7777".to_string()), "plain-ws public relay kept");
    }
